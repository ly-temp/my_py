...
parser.add_argument('-url', '--url_template',	help='url template: [;d]:num_replace [;s]:strg_replace', required=True)
parser.add_argument('-min', '--min_int',	help='counter start int')
parser.add_argument('-max', '--max_int',	help='counter end int')
parser.add_argument('-num', '--is_numbering',	help='use name from counter / strg file')
parser.add_argument('-log', '--is_logging',	help='write log')
parser.add_argument('-strg', '--strg_file',	help='string file')
parser.add_argument('-cookie', '--cookie_file',	help='cookie file')
